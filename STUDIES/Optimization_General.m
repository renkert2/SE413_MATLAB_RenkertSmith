classdef Optimization_General < handle  
    ...
    methods
        ...
        function [opt_X, opt_flight_time, output] = Optimize(obj, opts)
            ...
            [opt_X, fval, ~, output] = fmincon(@(X) -obj.flightTime(X,'SimulationBased', opts.SimulationBased, opts.FlightTimeOpts{:}),obj.X0, [], [], [], [], obj.lb, obj.ub, @(x) nlconBoundary(obj,x), optimopts);
