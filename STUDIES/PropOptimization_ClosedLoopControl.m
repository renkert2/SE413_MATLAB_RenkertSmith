classdef PropOptimization_ClosedLoopControl < handle
    ...
    properties
        ...
        Mission_Heights (1,:) = 1; % mission thrust factor = 1 -> input will be calculated to maintain hover
        Mission_Times (1,:) = 0; % mission thrust times -> starting times corresponding to mission_thrust_factors
        input_sched;
    end
